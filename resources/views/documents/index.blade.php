                ...
                @if($isOwner)
                    ...
                    @if($documents->isEmpty())
                        <div class="text-center py-8 text-gray-500">
                            <p>No tienes documentos en tu portafolio.</p>
                            <p class="text-sm">Sube tu primer documento usando el formulario de arriba.</p>
                        </div>
                    @else
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            {{ $doc->fecha_subida->format('d/m/Y') }}
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="{{ route('documents.download', $doc) }}" class="text-blue-600 hover:text-blue-900 mr-3">Descargar</a>
